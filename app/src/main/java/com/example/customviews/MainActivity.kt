...
import com.example.customviews.bottombuttons.BottomButtonsActivity
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.toBottomButtonsButton.setOnClickListener {
            val intent = Intent(this, BottomButtonsActivity::class.java)
